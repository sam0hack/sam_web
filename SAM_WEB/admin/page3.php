...
<h3>Page1</h3>
<?php
$sql=  mysql_query("select * from page3 where id=1")or die(mysql_error());
...
if(isset($_POST['sub']))
{
    ...
    if(empty($name))
    {
    mysql_query("update page3 set page_heading='$page_h',page_containt='$page_c' where id=1")or die(mysql_error());
...
move_uploaded_file($tmp_name, "$destination/".$name);
    ...
    mysql_query("update page3 set img='$saved',page_heading='$page_h',page_containt='$page_c' where id=1")or die(mysql_error());
